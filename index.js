...
//create a class (and its instance if the instance is empty/null)
class BankBranch {
...
//Declare instances and display
const branchA = new BankBranch('Cosmetics');
const branchB = new BankBranch('Retial');
